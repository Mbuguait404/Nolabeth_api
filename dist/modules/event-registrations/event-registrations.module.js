    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: event_registration_schema_1.EventRegistration.name, schema: event_registration_schema_1.EventRegistrationSchema },
                { name: event_schema_1.MyEvent.name, schema: event_schema_1.EventSchema },
            ]),
        ],
