...
class CreateMediaDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { title: { required: true, type: () => String }, type: { required: true, type: () => String }, url: { required: true, type: () => String }, thumbnail: { required: true, type: () => String }, description: { required: false, type: () => String }, category: { required: true, type: () => String } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateMediaDto.prototype, "thumbnail", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
