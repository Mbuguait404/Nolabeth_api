...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get a single resource by ID' }),
    openapi.ApiResponse({ status: 200, type: require("./entities/resource.entity").Resource }),
...
__decorate([
    ...
    openapi.ApiResponse({ status: 201, type: require("./entities/resource.entity").Resource }),
