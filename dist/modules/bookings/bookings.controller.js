...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new booking request' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List all bookings (admin only)' }),
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Patch)('admin/bookings/:id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a booking (admin only)' }),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete a booking (admin only)' }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
