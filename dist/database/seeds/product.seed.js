...
exports.products = [
    {
        ...
        badge: product_schema_1.ProductBadge.BESTSELLER,
        stock_status: product_schema_1.StockStatus.IN_STOCK,
        rating: 4.9,
        review_count: 45,
    ...
    },
    {
        ...
        badge: product_schema_1.ProductBadge.NEW,
        stock_status: product_schema_1.StockStatus.IN_STOCK,
        rating: 4.7,
        review_count: 28,
    ...
    },
    {
        ...
        badge: product_schema_1.ProductBadge.DIGITAL,
        stock_status: product_schema_1.StockStatus.IN_STOCK,
        rating: 4.6,
        review_count: 19,
    ...
    },
    {
        ...
        badge: product_schema_1.ProductBadge.POPULAR,
        stock_status: product_schema_1.StockStatus.IN_STOCK,
        rating: 5.0,
        review_count: 12,
...
async function seedProducts(connection) {
    const ProductModel = connection.model('Product', product_schema_1.ProductSchema);
    await ProductModel.deleteMany({});
    console.log('🗑️  Cleaned products collection');
    const created = await ProductModel.insertMany(exports.products);
